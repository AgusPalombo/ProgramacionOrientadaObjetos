...
public class CatalogoProductos {
	...
	public void modificarProducto(String codigo, String nuevaDescripcion, double nuevoPrecioUnitario, int nuevaCantStock, int nuevoStockMin) {
	...
	public void darBajaProducto(String codigo) {
		for (Producto product:listaProductos) {
			if(product.getCodigo()==codigo) {
